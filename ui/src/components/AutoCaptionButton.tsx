  ...
  if (job && (job.status === 'running' || job.status === 'queued')) {
    return (
      ...
      >
        ...
        <span className="hidden sm:inline">{translate('Auto Captioning...')}</span>
        <span className="sm:hidden">{translate('Captioning')}</span>
      </Link>
    );
  }
  return (
    ...
    >
      <span className="hidden sm:inline">{translate('Auto Caption')}</span>
      <span className="sm:hidden">{translate('Caption')}</span>
    </Button>
  );
}
