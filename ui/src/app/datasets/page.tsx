...
export default function Datasets() {
  ...
  const handleDeleteDataset = (datasetName: string) => {
    openConfirm({
      ...
      message: t('datasets.deleteMessage', { name: datasetName }),
      type: 'warning',
  ...
  const openNewDatasetModal = () => {
    openConfirm({
      ...
      message: t('datasets.enterName'),
      type: 'info',
      confirmText: t('common.create'),
      inputTitle: t('datasets.name'),
    ...
    <>
      <TopBar>
        ...
        <div>
          ...
          >
            <span className="sm:hidden">{t('datasets.new')}</span>
